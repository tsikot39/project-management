                    ...
                    <div className="p-6">
                      ...
                      <div className="flex items-start justify-between mb-4">
                        ...
                        <div className="flex items-center gap-2">
                          <Badge
                            className={`capitalize ${getStatusColor(project.status)} border`}
                          >
                          ...
                          <Button
                            ...
                            className="h-8 w-8 p-0 opacity-100 transition-opacity text-muted-foreground hover:text-foreground"
                          >
